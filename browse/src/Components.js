  ...
  return (
    <div className='flex sm:flex-wrap'>
      <div className='bg-slate-300 h-56 w-96 rounded-lg mt-20 ml-40 mr-40'>
        ...
        <Link to="/ProductList">
          <button className='ml-8 mt-4 transition-all delay-150 duration-300 ease-in-out cursor-pointer text-white w-28 h-12 rounded-xl bg-black hover:text-black hover:bg-white'>
            Browse Jobs
          </button>
        </Link>
      </div>
