...
export default function NavBar() {
  return (
    <div className='flex justify-end pt-5'>
      ...
      <Link to="/"> <li className='border-b ml-5 border-slate-800 hover:border-b-2 hover:border-white hover:text-white transition-all delay-150 duration-300 ease-in-out cursor-pointer focus'>Home
          </li></Link>
